...
class AdditionalConnectorTests(unittest.TestCase):
    def simulate(self, failed=(), timeouts=(), collect_only=False, process_code=0):
        ...
        def fake_run(args, **kwargs):
            ...
            Path(args[4]).write_text("24 °C\n2\n1\n21.5 °C" if "Heating" in sensor else "24 °C\n55 %")
    ...
    def test_failed_bedroom_does_not_abort_other_eight(self):
        ...
        self.assertEqual(sensors[-1]["id"], "galerie-sensor")
    ...
    def test_timeout_continues_without_copying_values(self):
        ...
        self.assertEqual(sum(s["measurement"] is not None for s in payloads[0]["sensors"]), 8)
